        ...
        <div className="bg-surface-container-lowest/80 dark:bg-inverse-surface/80 backdrop-blur-3xl border border-white/20 shadow-[0_8px_40px_rgba(43,76,190,0.08)] rounded-3xl p-8 md:p-10">
          ...
          <div className="text-center mb-10">
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-primary/10 mb-6">
              <span className="material-symbols-outlined text-primary text-4xl" style={{ fontVariationSettings: "'FILL' 1" }}>healing</span>
            </div>
            <h1 className="font-display-sm text-display-sm text-primary mb-2">Welcome Back</h1>
            <p className="font-body-lg text-body-lg text-on-surface-variant">Sign in to your Travel Health account</p>
          </div>
